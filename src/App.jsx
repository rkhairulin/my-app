...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://639a7fa13a5fbccb52683f6d.mockapi.io/tyrs')
            const cartData = await axios.get('https://639a7fa13a5fbccb52683f6d.mockapi.io/cart')
            const favoritesData = await axios.get('https://639a7fa13a5fbccb52683f6d.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://639a7fa13a5fbccb52683f6d.mockapi.io/cart/${id}`)
